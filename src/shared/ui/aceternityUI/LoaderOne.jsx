    ...
    return (
        <div className="flex items-center gap-2">
            <motion.div
                ...
                className="h-2 w-2 rounded-full border border-blue-300 bg-gradient-to-b from-blue-400 to-blue-300"
            />
            <motion.div
                initial={{
                    y: 0,
    ...
    return (
        <div className="flex items-center">
            <motion.div
                ...
                className="h-2 w-2 rounded-full bg-neutral-200 shadow-md dark:bg-neutral-500"
            />
            <motion.div
                initial={{
                    x: 0,
                ...
                className="h-2 w-2 -translate-x-2 rounded-full bg-neutral-200 shadow-md dark:bg-neutral-500"
            />
            <motion.div
                initial={{
                    x: 0,
                ...
                className="h-2 w-2 -translate-x-4 rounded-full bg-neutral-200 shadow-md dark:bg-neutral-500"
            />
        </div>
    );
};
