...
import { ClearMessage } from "../../redux/Compass-V1Slice";
import { Strings } from "../../../../../shared/static/StaticLayersData";
...
const Header = () => {
    ...
    const ClearChat = () => {
        ...
        Strings.definitionExpression = "1=1";
    };
    return (
        <>
            <div className="flex items-center justify-between h-5 md:h-10 px-4 ">
                {/* logo */}
                <div className="fr w-fit space-x-2">
                    ...
                    <p className="font-sec text-blue-50 font-semibold select-none text-sm md:text-xl">
                        CompassAI-V1
                    </p>
                </div>
                {/* items */}
